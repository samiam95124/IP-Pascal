...
procedure wrtnrm(var f: text; view s: string); forward;
...
Writes a string as normal to the given file.

*******************************************************************************}

procedure wrtnrm(var f: text; view s: string);

var i: integer;

begin

   for i := 1 to max(s) do write(f, nrmchr(s[i]))
