...
*   basicio.pas                                                               *
*                                                                             *
*   Contains all open, close, delete and existence checks on files. Generally *
*   contains all I/O dependencies.                                            *
*                                                                             *
******************************************************************************}

module parsedef;
...
const
   ...
   hashoff = 40;    { hash function offset }
...
type
   ...
   typ    = record { type entry }
               ...
               case t: types of { types }
                  ...
                  ticst:    (ival: sint);    { the value of the integer }
                  ...
                  tstet:    (sten: typptr;   { next set element }
                             stes: sint;     { starting value }
                             stee: sint;     { ending value }
                  ...
                  tsub:     (subt: typptr;   { base type }
                             subl: sint;     { lower bound }
                             subu: sint);    { upper bound }
   ...
   errcod = (enull,        { no error }
             ...
             { free } esflt27,      { system fault 27: Notify Moore/CAD }
