...
! is used.                                                                    !
!                                                                             !
! This is the old manual version of the file. The new version is generated by !
! ch2ph. This file is maintained as a backup, and because compile times are   !
! faster with it.                                                             !
!                                                                             !
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        ptocf	_lopen, kernel32__lopen, int, pstrz, int
	    ptocf	_lcreat, kernel32__lcreat, int, pstrz, int
	...
	ptocf	deletefile, kernel32_deletefilea, bool, pstrz
	ptocf	movefile, kernel32_movefilea, bool, pstrz, pstrz
	ptocf	findfirstfile, kernel32_findfirstfilea, int, pstrz, ptr
        ptocf   findnextfile, kernel32_findnextfilea, int, int, ptr
	...
	ptocf	getlocaltime, kernel32_getlocaltime, void, ptr
        ...
        ptocf   getsystemmetrics, user32_getsystemmetrics, int, int
        ptocf   createwindow, user32_createwindowexa, int, zer, pstrz, pstrz,\
                   int, int, int, int, int, int, int, int, ptr
        ptocf   createwindow_function_string_string_integer_integer_\
integer_integer_integer_integer_integer_integer_integer,\
                   user32_createwindowexa, int, zer, pstrz, pstrz,\
                   int, int, int, int, int, int, int, int, zer

        ptocf   createwindowex, user32_createwindowexa, int, int, pstrz, pstrz,\
                   int, int, int, int, int, int, int, int, ptr
        ptocf   createwindowex_function_integer_string_string_integer_integer_\
integer_integer_integer_integer_integer_integer_integer,\
                   user32_createwindowexa, int, int, pstrz, pstrz,\
                   int, int, int, int, int, int, int, int, zer
        ptocf   destroywindow, user32_destroywindow, bool, int
        ptocf   showwindow, user32_showwindow, bool, int, int
        ptocf   registerclass, user32_registerclassa, bool, wclsptr
        ptocf   updatewindow, user32_updatewindow, bool, int
        ptocf   getmodulehandle_n, kernel32_getmodulehandlea, int, zer
        ptocf   loadicon_n, user32_loadicona, int, zer, int
        ptocf   loadcursor_n, user32_loadcursora, int, zer, int
        ptocf   getstockobject, gdi32_getstockobject, int, int
        ptocf   selectobject, gdi32_selectobject, int, int, int
        ptocf   messagebox, user32_messageboxa, int, int, pstrz, pstrz, int
        ptocf   getmessage, user32_getmessagea, int, ptr, int, int, int
        ...
        ptocf   postthreadmessage, user32_postthreadmessagea, bool, int, int, int, int 
        ...
        ptocf   getupdaterect, user32_getupdaterect, bool, int, ptr, bool
        ptocf   getwindowrect, user32_getwindowrect, bool, int, ptr
        ptocf   getdesktopwindow, user32_getdesktopwindow, int
        ptocf   drawtext, user32_drawtexta, int, int, strl, ptr, int 
        ptocf   drawtexta, user32_drawtexta, int, int, strl, ptr, int 
        ptocf   textout, gdi32_textouta, bool, int, int, int, strl
        ...
        ptocf   setwindowtext, user32_setwindowtexta, bool, int, pstrz
        ptocf   getwindowtext, user32_getwindowtexta, int, int, zstrp
        ptocf   getwindowtextlength, user32_getwindowtextlengtha, int, int
        ptocf   setwindowpos, user32_setwindowpos, bool, int, int, int, int, int, int, int
        ptocf   getwindowlong, user32_getwindowlonga, int, int, int
        ptocf   setwindowlong, user32_setwindowlonga, int, int, int, int
        ptocf   callwindowproc, user32_callwindowproca, int, int, int, int, int, int
        ptocf   adjustwindowrectex, user32_adjustwindowrectex, bool, ptr, int, bool, int
	ptocf	getenvironmentvariable, kernel32_getenvironmentvariablea, int, pstrz, zstrp
	ptocf	setenvironmentvariable, kernel32_setenvironmentvariablea, bool, pstrz, pstrz
	ptocf	setenvironmentvariable_n, kernel32_setenvironmentvariablea, bool, pstrz, zer
	ptocf	createprocess_nn, kernel32_createprocessa, bool, pstrz, pstrz,\
                zer, zer, bool, int, evl, pstrz, ptr, ptr
        ptocf   getcurrentdirectory, kernel32_getcurrentdirectorya, int, lzstrp
        ptocf   setcurrentdirectory, kernel32_setcurrentdirectorya, bool, pstrz
        ptocf   waitforsingleobject, kernel32_waitforsingleobject, int, int, int
        ptocf   closehandle, kernel32_closehandle, bool, int
        ptocf   setfileattributes, kernel32_setfileattributesa, bool, pstrz, int
        ptocf   getfileattributes, kernel32_getfileattributesa, int, pstrz
        ptocf   getexitcodeprocess, kernel32_getexitcodeprocess, bool, int, ptr
        ptocf   createdirectory_n, kernel32_createdirectorya, bool, pstrz, zer
        ptocf   removedirectory, kernel32_removedirectorya, bool, pstrz
        ptocf   getdiskfreespace, kernel32_getdiskfreespacea, bool, pstrz, ptr, ptr, ptr, ptr
        ...
        ptocf   polyline, gdi32_polyline, bool, int, ptr, int
        ...
        ptocf   createfont, gdi32_createfonta, int, int, int, int, int, int,\
                   bool, bool, bool, int, int, int, int, int, pstrz
        ...
        ptocf   createthread, kernel32_createthread, int, zer, int, int, zer, int, ptr
        ptocf   terminatethread, kernel32_terminatethread, bool, int, int
        ...
        ptocf   createmutex, kernel32_createmutexa, int, zer, bool, zer
        ptocf   releasemutex, kernel32_releasemutex, bool, int
        ptocf   loadimage, user32_loadimagea, int, int, pstrz, int, int, int, int
        ptocf   loadimagea, user32_loadimagea, int, int, pstrz, int, int, int, int
        ...
        ptocf   chord, gdi32_chord, bool, int, int, int, int, int, int, int, \
                   int, int
        ptocf   createmenu, user32_createmenu, int
        ptocf   destroymenu, user32_destroymenu, bool, int
        ptocf   appendmenu, user32_appendmenua, bool, int, int, int, pstrz
        ptocf   drawmenubar, user32_drawmenubar, bool, int
        ptocf   setmenu, user32_setmenu, bool, int, int
        ptocf   enablemenuitem, user32_enablemenuitem, int, int, int, int
        ptocf   checkmenuitem, user32_checkmenuitem, int, int, int, int
        ptocf   sendmessage, user32_sendmessagea, int, int, int, int, int
        ptocf   sendmessage_function_integer_integer_string_integer, \
                user32_sendmessagea, int, int, int, zer, pstrz
        ptocf   sendmessage_function_integer_integer_integer_sc_tcitem_integer, \
                user32_sendmessagea, int, int, int, int, ptr
        ptocf   setscrollrange, user32_setscrollrange, bool, int, int, int, int, bool
        ptocf   setscrollpos, user32_setscrollpos, int, int, int, int, bool
        ptocf   setscrollinfo, user32_setscrollinfo, int, int, int, ptr, bool
        ptocf   getscrollinfo, user32_getscrollinfo, bool, int, int, ptr
        ptocf   setthreadpriority, kernel32_setthreadpriority, bool, int, int
        ptocf   getcurrentthreadid, kernel32_getcurrentthreadid, int
        ptocf   getcurrentthread, kernel32_getcurrentthreadid, int
        ptocf   attachthreadinput, user32_attachthreadinput, bool, int, int, bool
        ptocf   sleep, kernel32_sleep, void, int
        ptocf   switchtothread, kernel32_switchtothread, int
        ptocf   createupdowncontrol, comctl32_createupdowncontrol, int, int, int, \
                   int, int, int, int, int, int, int, int, int, int
        ptocf   setfocus, user32_setfocus, int, int
        ptocf   setforegroundwindow, user32_setforegroundwindow, bool, int
        ptocf   movewindow, user32_movewindow, bool, int, int, int, int, int, bool
        ptocf   choosecolor, comdlg32_choosecolora, bool, ptr
        ptocf   getopenfilename, comdlg32_getopenfilenamea, bool, ptr
        ptocf   getsavefilename, comdlg32_getsavefilenamea, bool, ptr
        ptocf   commdlgextendederror, comdlg32_commdlgextendederror, int
        ptocf   findtext, comdlg32_findtexta, int, ptr
        ptocf   replacetext, comdlg32_replacetexta, int, ptr
        ptocf   registerwindowmessage, user32_registerwindowmessagea, int, pstrz
        ptocf   choosefont, comdlg32_choosefonta, bool, ptr
        ptocf   createevent, kernel32_createeventa, int, zer, bool, bool, zer
        ptocf   setevent, kernel32_setevent, bool, int
        ptocf   resetevent, kernel32_resetevent, bool, int
        ptocf   pulseevent, kernel32_pulseevent, bool, int
        ptocf   getdialogbaseunits, user32_getdialogbaseunits, int
        ptocf   getparent, user32_getparent, int, int
        ptocf   getifentry, iphlpapi_getifentry, int, ptr
        ptocf   getversion, kernel32_getversion, int
        ptocf   regopenkey, advapi32_regopenkeya, int, int, pstrz, ptr
        ptocf   regcreatekey, advapi32_regcreatekeya, int, int, pstrz, ptr
        ptocf   regqueryvalue, advapi32_regqueryvaluea, int, int, pstrz, ptrd, ptr
        ptocf   regqueryvalueex, advapi32_regqueryvalueexa, int, int, pstrz, \
                   zer, ptr, zstrpd, ptr
        ptocf   regsetvalueex, advapi32_regsetvalueexa, int, int, pstrz, \
                   zer, ptr, pstrz, int
        ptocf   regclosekey, advapi32_regclosekey, int, int
        ptocf   regflushkey, advapi32_regflushkey, int, int
        ptocf   regdeletekey, advapi32_regdeletekeya, int, int, pstrz
        ptocf   getdrivetype, kernel32_getdrivetypea, int, pstrz
        ptocf   getwindowdc, user32_getwindowdc, int, int
        ptocf   enablewindow, user32_enablewindow, bool, int, bool
        ptocf   gdiflush, gdi32_gdiflush, bool
        ptocf   wsastartup, wsock32_wsastartup, int, int, ptr
        ptocf   socket, wsock32_socket, int, int, int, int
        ptocf   connect, wsock32_connect, int, int, ptr, int
        ptocf   recv, wsock32_recv, int, int, ptrl, int
        ptocf   send, wsock32_send, int, int, ptrl, int
        ptocf   wsagetlasterror, wsock32_wsagetlasterror, int
!        ptocf   disconnectex, wsock32_disconnectex, bool, int, zer, int, zer
        ptocf   closesocket, wsock32_closesocket, int, int
        ptocf   gethostbyname, wsock32_gethostbyname, ptr, pstrz
        ptocf   GetProcessId, kernel32_GetProcessId, int, int
        ptocf   keybd_event, user32_keybd_event, void, int, int, int, zer
!
! Wincon
!
...
! readconsoleoutput
! writeconsoleoutput
        ptocf   readconsoleoutputcharacter, kernel32_readconsoleoutputcharactera, bool, int, strlo, int, ptr
...
! setconsolectrlhandler
        ...
        ptocf   getconsoletitle, kernel32_getconsoletitlea, int, zstrp
        ptocf   setconsoletitle, kernel32_setconsoletitlea, bool, pstrz
! readconsole
! writeconsole
        ptocf   writeconsolew, kernel32_writeconsolew, bool, int, ptrl, ptr, zer
...
!
        ...
        ptocf   joygetdevcaps, winmm_joygetdevcapsa, int, int, ptr, int, 
        ...
        ptocf   playsound, winmm_playsound, bool, pstrz, int, int
        ptocf   mcisendstring_nnn, winmm_mcisendstringa, int, pstrz, zer, zer, zer
