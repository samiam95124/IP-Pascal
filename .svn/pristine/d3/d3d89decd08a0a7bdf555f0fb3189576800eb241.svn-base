...
;if false then begin;
   ...
   repeat
      ...
      if er.etype = etchkbox then begin
         ...
         end else writeln('!!! No button with id: ', er.butid:1, ' !!!')
   ...
   scrollsiz(1, (maxint div 4)*3);
   scrollvert(10+5, 10, 12+5, 20, 2);
   scrollsiz(2, maxint div 2);
   scrollvert(10+10, 10, 12+10, 20, 3);
   scrollsiz(3, maxint div 4);
   scrollvert(10+15, 10, 12+15, 20, 4);
   scrollsiz(4, maxint div 8);
...
;end;
   ...
   writeln;
   scrollvertsizg(x, y);
   scrollvertg(100, 100, 100+x div 2, 100+200, 1);
   scrollvertg(120, 100, 200, 100+200, 3);
   scrollhorizsizg(x, y);
   scrollhorizg(250, 100, 250+200, 100+y div 2, 2);
   ...
   repeat
      ...
      if er.etype = ettim then begin
         ...
         if prog < 20 then begin
            ...
            progbarpos(1, maxint-((20-prog)*(maxint div 20)));
   ...
   repeat
      ...
      if er.etype = ettabbar then begin
         ...
         end else if er.tabid = 2 then case er.tabsel of
         ...
         end else if er.tabid = 3 then case er.tabsel of
         ...
         end else if er.tabid = 4 then case er.tabsel of
