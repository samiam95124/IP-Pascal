...
!                                                                              !
! This version tests if having the flag array packed makes a difference.       !
!                                                                              !
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
! Clear flag array
!
        mov     ecx,((size+1)/8+1)/4 ! set length in words
...
!
        mov     ecx,0           ! set i := 0
for2:
        bt      [flags],ecx     ! check flags[i]
        jnc     for2end         ! not true, skip
...
! Variables
!
flags:  defvs   (size+1)/8+1    ! space for flag array
