...
integer_integer_integer_integer_integer_integer_integer,\
        ...
        ptocf   messagebox, user32_messageboxa, int, int, str, str, int
        ...
        ptocf   getwindowrect, user32_getclientrect, bool, int, ptr
        ...
        ptocf   setwindowtext, user32_setwindowtexta, bool, int, str
        ptocf   getwindowtext, user32_getwindowtexta, int, int, strl
	...
	ptocf	getenvironmentvariable, kernel32_getenvironmentvariablea, int, pstrz, strl
	ptocf	setenvironmentvariable, kernel32_setenvironmentvariablea, bool, pstrz, str
	...
	ptocf	createprocess_nn, kernel32_createprocessa, bool, pstrz, pstrz,\
        ...
        ptocf   getcurrentdirectory, kernel32_getcurrentdirectorya, int, lstr
        ...
        ptocf   appendmenu, user32_appendmenua, bool, int, int, int, str
        ...
        ptocf   sendmessage_function_integer_integer_string_integer, \
                user32_sendmessagea, int, int, int, zer, str
        ...
        ptocf   registerwindowmessage, user32_registerwindowmessagea, int, str
