...
sc_MB_OK                   = $00000000;
sc_MB_OKCANCEL             = $00000001;
sc_MB_ABORTRETRYIGNORE     = $00000002;
sc_MB_YESNOCANCEL          = $00000003;
sc_MB_YESNO                = $00000004;
sc_MB_RETRYCANCEL          = $00000005;
sc_MB_ICONHAND             = $00000010;
sc_MB_ICONQUESTION         = $00000020;
sc_MB_ICONEXCLAMATION      = $00000030;
sc_MB_ICONASTERISK         = $00000040;
sc_MB_ICONINFORMATION      = sc_MB_ICONASTERISK;
sc_MB_ICONSTOP             = sc_MB_ICONHAND;
sc_MB_DEFBUTTON1           = $00000000;
sc_MB_DEFBUTTON2           = $00000100;
sc_MB_DEFBUTTON3           = $00000200;
sc_MB_APPLMODAL            = $00000000;
sc_MB_SYSTEMMODAL          = $00001000;
sc_MB_TASKMODAL            = $00002000;
sc_MB_NOFOCUS              = $00008000;
sc_MB_SETFOREGROUND        = $00010000;
sc_MB_DEFAULT_DESKTOP_ONLY = $00020000;
sc_MB_TYPEMASK             = $0000000F;
sc_MB_ICONMASK             = $000000F0;
sc_MB_DEFMASK              = $00000F00;
sc_MB_MODEMASK             = $00003000;
sc_MB_MISCMASK             = $0000C000;
...
sc_int       = integer;          { windows signed integer }
...
sc_outlinetextmetric = record
   ...
   otmfsType: sc_UINT;
   otmsCharSlopeRise: sc_int;
   otmsCharSlopeRun: sc_int;
   otmItalicAngle: sc_int;
   otmEMSquare: sc_UINT;
   otmAscent: sc_int;
   otmDescent: sc_int;
   otmLineGap: sc_UINT;
   ...
   otmsStrikeoutPosition: sc_int;
   otmsUnderscoreSize: sc_int;
   otmsUnderscorePosition: sc_int;
...
sc_intarr250 = array [1..250] of sc_int;
...
function sc_getstdhandle(hdlrc: integer): integer; begin end;
function sc__lopen(view name: string; mode: integer): integer; begin end;
function sc__lcreat(view name: string; mode: integer): integer; begin end;
function sc__lclose(hdl: integer): integer; begin end;
function sc__lread(hdl: integer; var ba:  bytarr): integer; begin end;
function sc__lwrite(     hdl: integer; view ba:  bytarr): integer; begin end;
...
function sc_getfilesize(hdl: integer; var ups: integer): integer;
   begin end;
function sc_deletefilea(view name: string): boolean; begin end;
function sc_movefilea(view sn: string; view dn: string): boolean; begin end;
function sc_globalalloc(flg: integer; len: integer): gbtptr; begin end;
function sc_globalfree(view bp: gbtptr): integer; begin end;
function sc_getcommandlinea: pstring; begin end;
function sc_findfirstfilea(view name: string; var  data: sc_win32_find_dataa)
   : integer; begin end;
function sc_findnextfilea(hdl: integer; var data: sc_win32_find_dataa)
   : integer; begin end;
function sc_findclose(hdl: integer): integer; begin end;
...
function sc_filetimetodosdatetime(view ft: sc_filetime; var  date: sc_word;
   var  time: sc_word): boolean; begin end;
procedure sc_getsystemtime(var st: sc_systemtime); begin end;
function sc_gettickcount: integer; begin end;
procedure sc_getlocaltime(var st: sc_systemtime); begin end;
function sc_gettimezoneinformation(var tz: sc_time_zone_information): integer;
   begin end;
function sc_getlasterror: integer; begin end;
function sc_createwindowexa_n(exstl: integer; view cn: string; view wn: string;
   stl: integer; x: integer; y: integer; w: integer; h: integer; prnt: integer;
   menu: integer; inst: integer): integer; begin end;
function sc_destroywindow(h: sc_hwnd): boolean; begin end;
function sc_showwindow(hdl: integer; cmd: integer): boolean; begin end;
function sc_registerclassa(var wc: sc_wndclassa): boolean; begin end;
function sc_updatewindow(hdl: integer): boolean; begin end;
function sc_msgmirroraddr: integer; begin end;
function sc_wndprocadr(function wndproc(hwnd, imsg, wparam, lparam: integer)
   : integer): integer; begin end;
function sc_getmodulehandlea_n: integer; begin end;
function sc_loadicona_n(it: integer): integer; begin end;
function sc_loadcursora_n(ct: integer): integer; begin end;
function sc_getstockobject(index: integer): integer; begin end; 
function sc_selectobject(h: integer; o: integer): integer; begin end;
function sc_messageboxa(hdl:  integer; view text: string; view capt: string;
   typ:  integer): integer;begin end;
function sc_getmessagea(var m: sc_msg; h:  integer; mn: integer; mx: integer)
   : boolean; begin end;
function sc_peekmessage(var m: sc_msg; h: integer; mn: integer; mx: integer;
   rf: integer): boolean; begin end;
function sc_translatemessage(var m: sc_msg): boolean; begin end;
function sc_postmessage(h, m, w, l: integer): boolean; begin end;
procedure sc_postquitmessage(ec: integer); begin end;
function sc_defwindowproc(hw, um, wp, lp: integer): integer; begin end;
function sc_dispatchmessage(var m: sc_msg): integer; begin end;
function sc_beginpaint(h: integer; var p: sc_paint): integer; begin end;
function sc_endpaint(h: integer; var p: sc_paint): boolean; begin end;
function sc_getclientrect(h: integer; var r: sc_rect): boolean; begin end;
function sc_drawtexta(h: integer; view s: string; view r: sc_rect; f: integer)
   : integer; begin end;
function sc_dispatchmessagea(var m: sc_msg): integer; begin end;
function sc_textouta(h: integer; x, y: integer; view s: string): boolean;
   begin end;
function sc_getdc(h: integer): integer; begin end;
function sc_releasedc(wh: integer; dh: integer): boolean; begin end;
function sc_gettextmetrics(h: integer; var tm: sc_textmetric): boolean;
   begin end;
function sc_validatergn_n(h: integer): boolean; begin end;
function sc_showcursor(b: boolean): integer; begin end;
function sc_createcaret(w: integer; b: integer; x: integer; y: integer)
   : boolean; begin end;
function sc_destroycaret: boolean; begin end;
function sc_showcaret(w: integer): boolean; begin end;
function sc_hidecaret(w: integer): boolean; begin end;
function sc_setcaretpos(x, y: integer): boolean; begin end;
function sc_settextcolor(dc: integer; c:  integer): integer; begin end;
function sc_setbkcolor(dc: integer; c: integer): integer; begin end;
...
function sc_roundrect(dc: integer; x1, y1, x2, y2, xs, ys: integer): boolean;
   begin end;
function sc_setbkmode(dc: integer; bm: integer): integer; begin end;
...
function sc_settimer_n(wh: integer; ti: integer; t: integer): integer;
   begin end;
function sc_killtimer(wh: integer; ti: integer): boolean; begin end;
function sc_setwindowtexta(wh: integer; view s: string): boolean; begin end;
...
function sc_adjustwindowrectex(var r: sc_rect; s: sc_dword; m: boolean;
   es: sc_dword): boolean; begin end;
function sc_getenvironmentvariablea(view n: string; var v: string): integer;
   begin end;
function sc_setenvironmentvariablea(view n: string; view v: string): boolean;
   begin end;
function sc_setenvironmentvariablea_n(view n: string): boolean; begin end;
function sc_getenvironmentstringsa: sc_evsptr; begin end;
function sc_CreateProcessA_nn(view lpApplicationName: string;
   ...
   var lpProcessInformation: sc_PROCESS_INFORMATION): boolean; begin end;
...
function sc_WaitForSingleObject(hHandle: sc_HANDLE; dwMilliseconds: sc_DWORD)
   : sc_DWORD; begin end;
function sc_CloseHandle(hObject: sc_HANDLE): boolean; begin end;
function sc_GetCurrentDirectorya(var p: string): integer; begin end;
function sc_SetCurrentDirectorya(view p: string): boolean; begin end;
function sc_SetFileAttributesA(view lpFileName: string;
   dwFileAttributes: sc_DWORD): boolean; begin end;
function sc_GetFileAttributesA(view lpFileName: string): sc_DWORD; begin end;
function sc_GetExitCodeProcess(hProcess: sc_HANDLE; var lpExitCode: integer)
   : boolean; begin end;
function sc_CreateDirectoryA_n(view lpPathName: string): boolean; begin end;
function sc_RemoveDirectoryA(view lpPathName: string): boolean; begin end;
function sc_GetDiskFreeSpaceA(view lpRootPathName: string;
   ...
   : boolean; begin end;
procedure sc_exitprocess(ec: integer); begin end;
function sc_beep(f, d: integer): boolean; begin end;
function sc_createsolidbrush(c: sc_colorref): sc_hbrush; begin end;
function sc_fillrect(h: sc_hdc; var r: sc_rect; b: sc_hbrush): boolean;
   begin end;
function sc_deleteobject(o: sc_hgdiobj): boolean; begin end;
function sc_bitblt(d: sc_hdc; dx, dy, w, h: integer; s: sc_hdc; sx, sy: integer;
   rop: sc_dword): boolean; begin end; 
function sc_stretchblt(d: sc_hdc; dx, dy, dw, dh: integer; s: sc_hdc;
   sx, sy, sw, sh: integer; rop: sc_dword): boolean; begin end; 
function sc_createcompatibledc(h: sc_hdc): sc_hdc; begin end;
function sc_createcompatiblebitmap(hdl: sc_hdc; w, h: integer): sc_hbitmap;
   begin end;
function sc_movetoex_n(h: sc_hdc; x, y: integer): boolean; begin end;
function sc_lineto(h: sc_hdc; x, y: integer): boolean; begin end;
function sc_createpen(ps, w, c: integer): sc_hpen; begin end;
function sc_extcreatepen_nn(ps, w: integer; view lb: sc_logbrush): sc_hpen;
   begin end;
function sc_ellipse(h: sc_hdc; x1, y1, x2, y2: integer): boolean; begin end;
function sc_setpixel(h: sc_hdc; x, y: integer; c: sc_colorref): sc_colorref;
   begin end;
function sc_setrop2(h: sc_hdc; m: integer): integer; begin end;
...
function sc_createfont(h, w, e, o, wt: integer; i, u, s: boolean;
   cs, op, cp, q, pf: sc_dword; view fn: string): sc_hfont; begin end;
function sc_getoutlinetextmetrics(h: sc_hdc; l: integer; 
   var tm: sc_outlinetextmetric): boolean; begin end;
function sc_getcharabcwidths(h: sc_hdc; fc, lc: sc_uint; var wa: sc_abcs)
   : boolean; begin end;
function sc_getglyphoutline_metrics(h: sc_hdc; c: char;
   var m: sc_glyphmetrics; var t: sc_mat2): sc_dword; begin end;
function sc_gettextextentpoint32(h: sc_hdc; view s: string; var sz: sc_size)
   : boolean; begin end;
function sc_getdevicecaps(h: sc_hdc; i: integer): integer; begin end;
procedure sc_initializecriticalsection(var l: sc_critical_section); begin end;
procedure sc_entercriticalsection(var l: sc_critical_section); begin end;
procedure sc_leavecriticalsection(var l: sc_critical_section); begin end;
procedure sc_deletecriticalsection(var l: sc_critical_section); begin end;
function sc_loadimage(h: sc_hinstance; view s: string; t: sc_uint;
   cx, cy: sc_int; f: sc_uint): sc_handle; begin end;
function sc_getbitmapdimensionex(h: sc_hbitmap; var s: sc_size): boolean;
   begin end;
function sc_getobject_bitmap(h: sc_hgdiobj; l: sc_int; var bm: sc_bitmap): sc_int;
   begin end;
function sc_setstretchbltmode(h: sc_hdc; m: sc_int): sc_int; begin end;
function sc_deletedc(h: sc_hdc): boolean; begin end;
function sc_setviewportorgex_n(h: sc_hdc; x, y: sc_int): boolean; begin end;
function sc_getviewportextex(h: sc_hdc; var s: sc_size): boolean; begin end;
function sc_setviewportextex(h: sc_hdc; x, y: sc_int; var s: sc_size): boolean;
   begin end;
function sc_setwindowextex(h: sc_hdc; x, y: sc_int; var s: sc_size): boolean;
   begin end;
function sc_scaleviewportextex(h: sc_hdc; xm, xd, ym, yd: sc_int;
   var s: sc_size): boolean; begin end;
function sc_setmapmode(h: sc_hdc; mm: sc_int): sc_int; begin end;
function sc_lptodp_o(h: sc_hdc; var p: sc_point): boolean; begin end;
function sc_settextjustification(h: sc_hdc; be, bc: sc_int): boolean; begin end;
function sc_getcharacterplacement(h: sc_hdc; view s: string; me: sc_int;
   var r: sc_gcp_results; f: sc_dword): sc_dword; begin end;
function sc_exttextout_n(h: sc_hdc; x, y: sc_int; f: sc_uint; view s: string;
   sp: sc_intarr250_ptr): boolean; begin end;
function sc_polygon(h: sc_hdc; var pa: sc_point_arr): boolean; begin end;
function sc_arc(h: sc_hdc; x1, y1, x2, y2, sx, sy, ex, ey: sc_int): boolean;
   begin end;
function sc_pie(h: sc_hdc; x1, y1, x2, y2, sx, sy, ex, ey: sc_int): boolean;
   begin end;
function sc_chord(h: sc_hdc; x1, y1, x2, y2, sx, sy, ex, ey: sc_int): boolean;
   begin end;
...
sc_KEY_EVENT_RECORD = record
   ...
   KeyDown:         sc_BOOL;
   RepeatCount:     sc_WORD;
   VirtualKeyCode:  sc_WORD;
   VirtualScanCode: sc_WORD;
   Char:            sc_sinchr;
   ControlKeyState: sc_DWORD;
...
sc_MOUSE_EVENT_RECORD = record
   ...
   space1:          sc_WORD; { spacer }
   MousePosition:   sc_COORD;
   ButtonState:     sc_DWORD;
   ControlKeyState: sc_DWORD;
   EventFlags:      sc_DWORD;
...
function sc_peekconsoleinput(h: sc_handle; var ers: sc_INPUT_RECORD_arr;
   var n: sc_dword): boolean; begin end;
...
{*}function sc_readconsoleoutputcharacter(h: sc_handle;
   view s: string; c: sc_pcoord; var n: sc_dword): boolean; begin end;
...
function sc_writeconsoleoutputcharacter(h: sc_handle; view s: string;
   xy: sc_pcoord; var l: sc_dword): boolean; begin end;    
function sc_writeconsoleoutputattribute(h: sc_handle; view s: sc_intarr;
   xy: integer; var l: sc_dword): boolean; begin end;  
...
{*}function sc_fillconsoleoutputattribute(h: sc_handle; w: sc_word; n: sc_dword;
   xy: sc_pcoord; var l: sc_dword): boolean; begin end;
{*}function sc_getconsolemode(h: sc_handle; var m: sc_dword): boolean; begin end;
{*}function sc_getnumberofconsoleinputevents(h: sc_handle; var n: sc_dword)
   : boolean; begin end;
function sc_getconsolescreenbufferinfo(h: sc_handle;
    var bi: sc_console_screen_buffer_info): boolean; begin end;
{*}function sc_getlargestconsolewindowsize(h: sc_handle): sc_pcoord; begin end;
function sc_getconsolecursorinfo(h: sc_handle; var ci: sc_console_cursor_info)
   : boolean; begin end;
{*}function sc_getnumberofconsolemousebuttons(var n: sc_dword): boolean; begin end;
{*}function sc_setconsolemode(h: sc_handle; m: sc_dword): boolean; begin end;
{*}function sc_setconsoleactivescreenbuffer(h: sc_handle): boolean; begin end;
{*}function sc_flushconsoleinputbuffer(h: sc_handle): boolean; begin end;
{*}function sc_setconsolescreenbuffersize(h: sc_handle; s: sc_pcoord): boolean; begin end;
...
{*}function sc_scrollconsolescreenbuffer(h: sc_handle; view sr, cr: sc_small_rect;
   d: sc_pcoord; view f: sc_char_info): boolean; begin end;
...
{*}function sc_setconsolewindowinfo(h: sc_handle; a: sc_bool; view cw: sc_small_rect)
   : boolean; begin end;
{*}function sc_setconsoletextattribute(h: sc_handle; a: sc_word): boolean; begin end;
...
{*}function sc_generateconsolectrlevent(ce: sc_dword; gid: sc_dword): boolean;
   begin end;
{*}function sc_allocconsole: boolean; begin end;
{*}function sc_freeconsole: boolean; begin end;
{*}function sc_getconsoletitle(var s: string): sc_dword; begin end;
{*}function sc_setconsoletitle(view s: string): boolean; begin end;
...
{*}function sc_createconsolescreenbuffer_nn(a, s: sc_dword; f: sc_dword)
   : sc_handle; begin end;
{*}function sc_getconsolecp: sc_uint; begin end;
{*}function sc_setconsolecp(ci: sc_uint): boolean; begin end;
{*}function sc_getconsoleoutputcp: sc_uint; begin end;
{*}function sc_setconsoleoutputcp(cp: sc_uint): boolean; begin end;
...
function sc_joysetcapture(wh: integer; di: integer; pt: integer; c: boolean)
   : integer; begin end;
function sc_joyreleasecapture(di: integer): integer; begin end;
function sc_joygetnumdevs: integer; begin end;
function sc_midioutgetnumdevs: sc_uint; begin end;
function sc_midioutopen_nnn(var h: sc_hmidiout; id: integer): sc_mmresult;
   begin end;
function sc_midioutclose(h: sc_hmidiout): sc_mmresult; begin end;
...
function sc_playsound(view s: string; h: sc_hmodule; f: sc_dword): boolean;
   begin end;
function sc_mcisendstring_nnn(view s: string): sc_mcierror; begin end;
function sc_timegettime: sc_dword; begin end;
function sc_timekillevent(tid: sc_uint): sc_mmresult; begin end;
function sc_timesetevent(d, r: sc_uint;
   procedure tp(id, m: sc_uint; u, dw1, dw2: sc_dword); u: sc_dword;
   f: sc_uint): sc_mmresult; begin end;
