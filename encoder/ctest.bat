...
c:\projects\assm\ln\ln runfile=maclib c:\projects\pascomp\windows_platform\serlib libthunk c:\ip\windows\i80386\lib\main test c:\ip\windows\i80386\lib\cap /ps=$401000 /vs=$418000 /lv /ll /lm > test.loc
