...
This file is automatically generated by ch2ph. Do not edit this file
...
procedure sc_myproc(i: sc_c_lang_int; j: sc_c_lang_int; k: sc_c_lang_int); 
   begin end;
overload procedure sc_myproc(i: sc_c_lang_int); begin end;
overload procedure sc_myproc(i: sc_c_lang_int; j: sc_c_lang_int); begin end;
overload procedure sc_myproc(i: sc_c_lang_int; k: sc_c_lang_int); begin end;

{ 1 function definitions output }
